...
local IAF_F_4E_2000 =  {
	...
	Name 				=   'IAF_F_4E_2000',
	DisplayName			= _("IAF F-4E Kurnass 2000"),
        EmptyWeight = "14461",
        MaxFuelWeight = "4864",
        MaxHeight = "19000",
        MaxSpeed = "2370",
	...
	{
		{
			...
			desrt    	= 'IAF_F_4E_2000'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; -- Fire on the ground after destoyed: 300sec 2m
			username	= 'IAF_F_4E_2000';
        ...
        Sensors = {
            RADAR = "AN/APG-63",--f15RADAR = "AN/APQ-120", --update RADAR to F-15C RADAR
            RWR = "Abstract RWR",
        },
