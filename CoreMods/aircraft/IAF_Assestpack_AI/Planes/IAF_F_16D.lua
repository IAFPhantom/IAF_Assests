...
IAF_F_16D =  {
	...
	Pylons =     {
		 ...
		 pylon(1, 0, 0, 0, 0, {use_full_connector_position=true, connector = "AIM9Pylon1" },
			{
				{ CLSID = "{D078E3E5-30C1-444e-A09E-6EEDCD334582}" ,arg_increment = -0.1},
				{ CLSID = "{9701DB51-AECB-42c6-A4F6-D5D8793E4D81}" ,arg_increment = -0.1},
				...
				{ CLSID = "{Refael_Python-5}" ,arg_increment = -0.1},
				{ CLSID = "{Refael_Derby}" ,arg_increment = -0.1},				
				{ CLSID = "{Refael_DerbyER}" ,arg_increment = -0.1},				
			}
		),
