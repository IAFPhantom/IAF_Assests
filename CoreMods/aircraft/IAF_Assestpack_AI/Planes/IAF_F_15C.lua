...
------VSN
	...
	Pylons =     {
		...
		pylon(1, 0, 0.660000, -0.078000, -3.325000,
			...
			{
				{ CLSID = "{8D399DDA-FF81-4F14-904D-099B34FE7918}" ,arg_increment = -0.1}, --AIM-7M
				...
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E741}" ,arg_increment = -0.1},--red
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E742}" ,arg_increment = -0.1},--green
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E743}" ,arg_increment = -0.1},--blue
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E744}" ,arg_increment = -0.1},--white
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E745}" ,arg_increment = -0.1},--yellow
				{ CLSID = "{A4BCC903-06C8-47bb-9937-A30FEDB4E746}" ,arg_increment = -0.1},--orange
		...
		pylon(2, 0, -0.155000, -0.343000, -2.944000,
			...
			{
				{ CLSID = "{E1F29B21-F291-4589-9FD8-3272EEC69506}" ,arg_value = 0,Cx_gain = 1/2.2},-- fuel tank 610
				...
				{ CLSID	=   "{Mk_87}",arg_value = 0}, -- training mk-82
--				{ CLSID	=   "{Mk_83_T}",arg_value = 0}, -- mk-83
--				{ CLSID	=   "{Mk_84_T}",arg_value = 0}, -- mk-84
			}
		),
...
--				{ CLSID	=   "{Mk_84_T}",arg_value = 0}, -- mk-84
		...
		pylon(9, 0, 0.660000, -0.078000, 2.563000,
			{
				use_full_connector_position = true,
				arg 	  = 317,
				arg_increment = 0.0,
...
--				{ CLSID	=   "{Mk_84_T}",arg_value = 0}, -- mk-84
		...
		pylon(11, 0, 0.660000, -0.078000, 3.325000,
			{
				use_full_connector_position = true,
				arg 	 	  = 317,
				arg_increment = 0.0,
