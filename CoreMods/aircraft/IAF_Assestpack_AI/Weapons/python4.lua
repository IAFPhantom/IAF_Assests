...
local Python_4 =     
{
        ...
        t_marsh = 8.0,		-- While working in the marching mode ? [sec]
        ...
        Fi_excort = 1.57, 	-- tracking angle ( sight . ) missile 90 
        Fi_search = 1.04, 	-- limit angle free search- 60
		...
		ccm_k0 = 0.4,  -- Counter Countermeasures Probability Factor. Value = 0 - missile has absolutely resistance to countermeasures. Default = 1 (medium probability)
		...
		0.78 , -- 7 Alfa_max  максимальный балансировачный угол, радианы  balansirovachny (balancing?) maximum angle radians
	...
	--	t_statr		t_b		t_accel		t_march		t_inertial		t_break		t_end			-- Stage
		-1.0,		-1.0,	4.0,  		8.0,		0.0,			0.0,		1.0e9,         -- time of stage, sec
		 ...
		 12.0, -- Прогноз времени полета ракеты  --- The forecast of the missile's flight time
		 ...
		 15000.0, -- дальность ракурс   180(навстречу) град,  Н=10000м, V=900км/ч, м
...
declare_loadout(
		{
			...
			Picture			=	"python4.png",
			displayName		=	_("Refael Python 4"),
			wsTypeOfWeapon	=	Python_4.wsTypeOfWeapon,
			...
			Elements   =   
			{ 
				{	ShapeName	=	"Python4" ,	Position   =   {0.0,   0.0,   0.0}},
			}, 
		})
